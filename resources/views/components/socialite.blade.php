    ...
    <div class="mt-6 flex items-center justify-center">
        ...
        <div>
            @if (Wallo\FilamentCompanies\Socialite::hasTwitterOAuth1Support())
                <a href="{{ route('oauth.redirect', ['provider' => Wallo\FilamentCompanies\Providers::twitter()]) }}" class="inline-flex w-full justify-center rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-white dark:focus:border-primary-500 py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600">
