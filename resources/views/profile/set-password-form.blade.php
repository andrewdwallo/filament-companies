<x-filament-companies::grid-section>
    ...
    <form wire:submit="setPassword" class="col-span-2 sm:col-span-1 mt-5 md:mt-0">
        <x-filament::card>
            <x-filament-forms::field-wrapper id="password" statePath="password" required label="{{ __('filament-companies::default.labels.new_password') }}">
                <x-filament-companies::input id="password" type="password" wire:model.live="state.password" autocomplete="new-password" />
            ...
            <x-filament-forms::field-wrapper id="password_confirmation" statePath="password_confirmation" required label="{{ __('filament-companies::default.labels.password_confirmation') }}">
                <x-filament-companies::input id="password_confirmation" type="password" wire:model.live="state.password_confirmation" autocomplete="new-password" />
            </x-filament-forms::field-wrapper>
