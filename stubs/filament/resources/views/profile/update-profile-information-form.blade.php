<x-filament-companies::form-section submit="updateProfileInformation">
    <x-slot name="title">
    ...
    <x-slot name="form">
        ...
        @if (Wallo\FilamentCompanies\FilamentCompanies::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <x-filament-companies::secondary-button class="mt-2 mr-2" type="button" x-on:click.prevent="$refs.photo.click()">
                    {{ __('Select A New Photo') }}
                </x-filament-companies::secondary-button>

                @if ($this->user->profile_photo_path)
                    <x-filament-companies::secondary-button type="button" class="mt-2" wire:click="deleteProfilePhoto">
                        {{ __('Remove Photo') }}
                    </x-filament-companies::secondary-button>
                @endif
    ...
    <x-slot name="actions">
        ...
        <x-filament-companies::button wire:loading.attr="disabled" wire:target="photo">
            {{ __('Save') }}
